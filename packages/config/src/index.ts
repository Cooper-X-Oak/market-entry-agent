...
export const environmentSchema = z.object({
  ...
  OPENAI_MODEL_RESEARCH: z.string().default('gpt-6-astra'),
  OPENAI_MODEL_EXTRACTION: z.string().default('gpt-6-astra'),
  OPENAI_MODEL_WRITING: z.string().default('gpt-6-astra'),
