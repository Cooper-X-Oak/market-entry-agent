...
export const domainEventTypeSchema = z.enum([
  ...
  'mission.capability_review_completed.v1', 'mission.route_review_completed.v1',
  'mission.target_review_completed.v1', 'mission.action_review_requested.v1',
  ...
  'target.assessed.v1', 'target.selected.v1',
  ...
  'contact_path.research_required.v1',
  'action_card.version_created.v1', 'action_card.review_requested.v1',
  'action_card.changes_requested.v1', 'action_card.approved.v1', 'action_card.executed.v1', 'action_card.exported.v1',
